...
export const LandingPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen text-white flex flex-col bg-[#0E1117]">
      {/* Auth Modal */}
      {showAuthModal && (
      ...
      {/* Header */}
      <header className="py-4 px-8 flex justify-between items-center border-b border-white/10">
         <h1 className="text-2xl font-bold tracking-tight bg-gradient-to-r from-cyan-400 to-blue-500 text-transparent bg-clip-text">
            VoiceGen Pro
          </h1>
      ...
      <main className="flex-grow flex flex-col items-center justify-center text-center p-8">
        <div className="animate-fade-in max-w-4xl">
          <h2 className="text-5xl md:text-7xl font-bold tracking-tight bg-gradient-to-r from-cyan-300 to-blue-400 text-transparent bg-clip-text">
      ...
      {/* Footer */}
      <footer className="py-4 px-8 text-center text-gray-500 text-sm border-t border-white/10">
